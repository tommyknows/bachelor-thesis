...
% TODO: rewrite first sentence. Also, Rust being 'more popular' is dangerous, too.
...
% TODO: unclear first sentence, not specific enough.
...
% TODO: should not be a list. rewrite to keep the flow
\begin{itemize}
...
% TODO: move example to appendix and link it here instead.
