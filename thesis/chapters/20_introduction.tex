...
including Rust, Kotlin, Go and Dart. They all had functions as first-class citizens in
the language since their initial release.

For example Rust, being the `most popular programming language' for 4 years in a row (2016--2019)
...
Rust code, a functional style can be clearly observed.
