...
% TODO: Abgrenzung zu Application für mich noch nicht ganz klar. Das Beispiel in diesem
% Kapitel würde auch ins letzte Kapitel passen.
...
% TODO: talk a bit more about this code?
Demonstrations of these functions and how functional Go code looks like can be seen in
Chapter~\ref{ch:application}.
%the code block~\ref{code:funcexample}. The example shows how lists can be processed with
%the new built-in functions in a purely functional way.
