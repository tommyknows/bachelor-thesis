...
\mintinline{haskell}|foldl| and \mintinline{haskell}|foldl'|; `map' includes
occurrences of \mintinline{haskell}|fmap|, \mintinline{haskell}|mapM| and
\mintinline{haskell}|mapM\_|.
...
% TODO:
% Hier kommt mir in den Sinn, dass ein paar Funktionen über Listen (weiss gerade nicht,
%wie viele es sind), mit denen alle anderen Listenfunktionen implementiert werden können.
%Sicher gehören first, rest, cons dazu.
%Das Problem hier ist aber, dass das nicht hilft, denn da kommen wieder die Typen der Slices ins Spiel.
