...
% TODO: "Sanduhr",
% "Because of this difficulty" - was genau?
% Sign Posting (like, furthermore, however). e.g. "The methods used in here..."
% Leser mehr fuehren
% Haskell zu spezifisch?
% `like' -> such as
% "Generelle Conclusion" (sanduhr) fehlt
...
%Further, because Go is missing polymorphism, the most popular higher-order functions
%will need to be added to the built-in functions in the compiler in order to achieve
